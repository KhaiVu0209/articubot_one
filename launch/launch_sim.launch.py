...
from launch import LaunchDescription #mô tả toàn bộ các hành động muốn chạy
...
def generate_launch_description():
    ...
    # Spawner node from the gazebo_ros package . The entity Include Robot vao trong Gazebo 
